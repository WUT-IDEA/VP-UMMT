...
EXP_NAME=unmt-fintune-${PRE}

MLM_PATH="${ROOT}/acmmm/pretrained/${SRC}-${TGT}/mlm-mscoco-multi30k/best-valid_${PRE}_ppl.pth"
...
python ../train.py  --beam_size 8 --exp_name $EXP_NAME  --dump_path ${DUMP_PATH} \
    ...
    --validation_metrics "valid_${SRC}-${TGT}_mt_bleu,valid_${TGT}-${SRC}_mt_bleu" --eval_from 13